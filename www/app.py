...
# Day-1 Content
#################################################################
# # Define the page return as: "Awesome Website"
# async def index(request):
#     return web.Response(body=b'<h1>Awesome Website</h1>', content_type='text/html')

# # Build the server application, and listen to port 9000's http request, respond with index.html
# def init():
#     app = web.Application()
